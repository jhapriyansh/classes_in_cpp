...
// Can be declared inside public/private section of the class (no change will be
// reflected). Can't access members directly by their names and needs
// object_name.member_name to access.