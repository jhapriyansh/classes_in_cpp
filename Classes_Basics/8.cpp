...
class Calculator {
public:
  // Forward declaration of function promises compiler with 2 complex class
  // objects.
...
int Calculator::sumRealComplex(Complex c1, Complex c2) { return c1.a + c2.a; }

int Calculator::sumImgComplex(Complex c1, Complex c2) { return c1.b + c2.b; }
